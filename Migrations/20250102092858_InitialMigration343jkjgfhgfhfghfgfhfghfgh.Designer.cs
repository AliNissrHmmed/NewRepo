...
namespace ERPPURCHASES.Migrations
{
    ...
    [Migration("20250102092858_InitialMigration343jkjgfhgfhfghfgfhfghfgh")]
    partial class InitialMigration343jkjgfhgfhfghfgfhfghfgh
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ERP.Ma_Subgroup", b =>
                {
                    ...
                    b.Property<Guid>("maingroup_id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("maingroup_id");
            ...
            modelBuilder.Entity("ERP.Ma_Subgroup", b =>
                {
                    ...
                    b.HasOne("ERP.Or_Maingroup", "maingroups")
                        .WithMany("Ma_Subgroups")
                        .HasForeignKey("maingroup_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
